                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            ...
                            <p class="p-heading p-large">ระบบติดตามงาน กรุณาใส่เลขติดตามงานของท่าน</p>
                            <form method="POST" action="ListOrder.php">
                            
                                <div class="form-row justify-content-center">
                                            <div class="form-group col-md-4">
                                                
                                                <input type="text" class="form-control " placeholder="กรุณากรอกเบอร์โทรศัพท์"  id="phone" name="phone" >
                                            </div>
                                            
                                    
                                
                                </div>
                                    <!-- <button type="button" class="btn-solid-lg page-scroll"  name='saveBtn' id='saveBtn'>ตรวจสอบ</button> -->
                                    <button type="submit" class="btn-solid-lg page-scroll"  >ตรวจสอบ</button>
                            </form>
